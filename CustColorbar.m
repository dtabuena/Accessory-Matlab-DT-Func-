function [Handle] = CustColorbar( ColorMin, ColorMax, ColorMap, YaxLabel, labelAngle )
...
%     axes('Position', [.3 .1 .7 .8]);
    ...
    Handle = surf( 1:2 , linspace(ColorMin, ColorMax, 255)' ,repmat(linspace(ColorMin, ColorMax, 255)', [1 2]), 'EdgeColor', 'interp');
    box on;
    grid off
    xlim([1 2]);
